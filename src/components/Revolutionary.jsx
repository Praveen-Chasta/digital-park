	 ...
	 return (<>
          <section className="py-5 revolutionary__wrapper text-center position-relative"> 
							<div className="container py-sm-4">
								<h2 className="text-center fs-1 fw-semibold text-dark mb-3 wow slideInDown" data-wow-offset="2" data-wow-iteration="2">A Revolutionary Step in the Online Examination System</h2>
								...
								<div className="row g-4 g-lg-5 mt-4 row-cols-1 row-cols-sm-2  row-cols-md-3 row-cols-lg-3">
											<div className="wow slideInUp" data-wow-offset="2" data-wow-iteration="2">
												<div className="info__card">
													<figure className="icon__box bg-blue mx-auto rounded-circle d-flex justify-content-center align-items-center">
														<img 
															src={EasyLearning}
															alt="Simple to learn" width="40" height="43"
											...
											<div className="wow slideInUp" data-wow-offset="9" data-wow-iteration="9">
												<div className="info__card">
													<figure className="icon__box bg-blue mx-auto rounded-circle d-flex justify-content-center align-items-center">
														<img 
